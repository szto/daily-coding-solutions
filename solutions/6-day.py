...
assert llist.get(2) == "a"
assert llist.get(3) == "b"


"""
I was not able to solve this problem. I have followed the code from this [link](https://github.com/szto/daily-coding-problem/blob/master/solutions/problem_006.py)
"""
